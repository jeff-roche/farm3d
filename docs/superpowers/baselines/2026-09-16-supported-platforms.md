...
|---|---|---|---|
| Frontend build | 2026-09-17T14:02:26Z | Exit 0; TypeScript/Vite passed | `/tmp/farm3d-f0/final/just-build.log` |
| Frontend tests | 2026-09-17T14:02:38Z | Exit 0; 14 files, 130 tests passed | `/tmp/farm3d-f0/final/just-test.log` |
| Rust tests | 2026-09-17T14:02:57Z | Exit 0; 110 library + 1 parent IPC integration + 3 snapshot tests passed; 1 child target ignored by the outer harness and passed when invoked by the parent | `/tmp/farm3d-f0/final/just-test-rust.log` |
...
| Final exact full package | 2026-09-17T14:03:04Z | Exit 0; `.deb`, `.rpm`, and AppImage completed | `/tmp/farm3d-f0/final/just-package.log` |
| Release executable launch | 2026-09-17T14:03:48Z | Rebuilt executable (mtime `2026-09-17T14:03:40Z`) alive for 10 seconds with display available; then SIGTERM, wait status 143 | `/tmp/farm3d-f0/final/launch-result.log` |
| Live Moonraker | 2026-09-17T14:04:46Z | Not run; configured endpoint variable absent, no probe attempted | `/tmp/farm3d-f0/final/moonraker-presence.log` |
